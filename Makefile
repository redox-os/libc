...
all: binutils bin/c-test bin/ed bin/lua bin/luac bin/nasm bin/ndisasm bin/pcc bin/sdl-test bin/thread-test lib/crt0.o lib/libc.a lib/libm.a lib/libpng.a lib/libz.a
